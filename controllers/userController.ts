...
export const userController = {
  ...
  getAllUsers: async (req: Request, res: Response) => {
    try {
      const result = await User.query('SELECT id, username, email, full_name, bio, avatar_url, created_at, updated_at FROM users');
  ...
  updateUser: async (req: Request, res: Response) => {
    try {
      ...
      const allowedUpdates = ['username', 'email', 'full_name', 'bio', 'avatar_url', 'password'];
